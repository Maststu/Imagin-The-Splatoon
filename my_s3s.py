...
def fetch_detailed_result(is_vs_history, history_id):
	...
	query2_hist["_id"]=query2_hist["id"]
	
	if bankara_col.find({"playedTime":query2_hist["playedTime"]}) is None:
		print("new_insert")
		#bankara_col.insert_one(query2_hist)
	else:
